...
// $.getJSON(
//     "https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyDdFsJYe2v7ndOL3-cZEXEn3jWDx_o_w8s",
//     function (data) {
//         console.log(data.items[0].family);
//         console.log(data.items[2].family);
//         console.log(data.items[3].family);
//         console.log(data.items[4].family);
//         // data.items.forEach((font) => {
//         //     document.getElementById("fonts").innerHTML += "<option value='".concat(font.family, "'>", font.family, "</option>");
//         // });
//     }
// );
...
document.getElementById("fonts").onchange = function () {
    ...
    var fontName = document.getElementById("fonts").value;
    runFont(fontName);
};
...
function runFont(font) {
    if (!fontsLoaded[font]) {
        ...
        // var reloadLayers = function (evt) {
        //     canvas.getObjects().forEach((object) => {
        //         document.removeChild(object);
        //     });
        // };
        
        // canvas.on("object:added", reloadLayers);
